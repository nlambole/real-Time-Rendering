...
int main(void)
{
	...
	int a_nrl = 13;
	printf("Integer Decimal Value Of 'a_nrl' = %d\n", a_nrl);
	printf("Integer Octal Value Of 'a_nrl' = %o\n", a_nrl);
	printf("Integer Hexadecimal Value Of 'a_nrl' (Hexadecimal Letters In Lower Case) = %x\n", a_nrl);
	printf("Integer Hexadecimal Value Of 'a_nrl' (Hexadecimal Letters In Lower Case) = %X\n\n", a_nrl);

	char ch_nrl = 'A';
	printf("Character ch_nrl = %c\n", ch_nrl);
	...
	unsigned int b_nrl = 7;
	printf("Unsigned Integer 'b_nrl' = %u\n\n", b_nrl);
	...
	printf("Double Hexadecimal Value Of 'd_pi' (Hexadecimal Letters In Lower Case) = %a_nrl\n", d_pi);
