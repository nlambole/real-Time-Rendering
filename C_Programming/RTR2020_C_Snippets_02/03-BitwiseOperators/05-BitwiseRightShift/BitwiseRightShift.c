...
int main(void)
{
	...
	printf("\n\n");
	printf("By How Many Bits Do You Want To Shift A = %d To The Right ? ", a_nrl);
	scanf("%u", &num_bits);

	printf("\n\n\n\n");
	result = a_nrl >> num_bits;

	printf("Bitwise RIGHT-SHIFTing A = %d By %d Bits \nGives The Result = %d (Decimal).\n\n", a_nrl, num_bits, result);
...
// ****** THE ONLY OBJECTIVE OF WRITING THIS FUNCTION WAS TO OBTAIN THE BINARY AND BIT-SHIFTING COULD BE UNDERSTOOD WITH GREAT EASE ******
