...
struct MyData
{
	...
	double d_nrl;
	char c_nrl;
}data; //Declarations a single struct variable of type 'struct MyData' globally ...
...
int main(void)
{
	...
	//Calculations Size Of The Data Members Of 'struct MyData'
	...
	printf("\n\n Data Members Of 'sturct MyData' ARE : \n\n");
