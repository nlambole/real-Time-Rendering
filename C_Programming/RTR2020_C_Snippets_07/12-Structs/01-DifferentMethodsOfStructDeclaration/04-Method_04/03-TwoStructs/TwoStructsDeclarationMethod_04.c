...
struct MyPoint point; //Declararing a single variable of type 'struct Mypoint' globally...
struct MyPointProperties point_properties_nrl; //declaraing a single variable of type 'struct MyPointProperties' globally...

int main(void)
{	
	//Variable Declarations.....
	struct MyPoint point; //Declararing aa single variable of type 'struct Mypoint' globally...
	struct MyPointProperties point_properties_nrl; //Declaraing a single variable of type 'struct MyPointProperties' globally...
