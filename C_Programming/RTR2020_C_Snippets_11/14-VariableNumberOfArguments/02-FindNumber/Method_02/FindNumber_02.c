...
{
	//Functionns Prototypes
	int va_FindNumber_nrl(int, int, va_list);
...
int va_FindNumber_nrl(int num_to_be_found, int num, va_list list)
{
	//Variable Declarations
	int count_of_num_nrl = 0;
	int n_nrl;
