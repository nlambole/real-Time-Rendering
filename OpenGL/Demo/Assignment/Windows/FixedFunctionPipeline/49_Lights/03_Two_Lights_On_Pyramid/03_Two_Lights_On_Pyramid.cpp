...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdlie, int iCmdShow)
{
	...
	// Create Window
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Two Light On Pyramid : Nandlal Lambole"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, Width, Height, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
	ghwnd = hwnd;
...
void Initialize(void)
{
	...
	//Light 
	glLightfv(GL_LIGHT0, GL_AMBIENT, LightAmbient0); //f - float. v- Vector
	glLightfv(GL_LIGHT0, GL_DIFFUSE, LightDiffuse0);
	glLightfv(GL_LIGHT0, GL_POSITION, LightPosition0);
	glLightfv(GL_LIGHT0, GL_SPECULAR, LightSpecular0);

	glLightfv(GL_LIGHT1, GL_AMBIENT, LightAmbient1); //f - float. v- Vector
