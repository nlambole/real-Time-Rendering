...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindow(szClassName, TEXT("3D Texture : Nandlal Lambole"), WS_OVERLAPPEDWINDOW, Width, Height, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
void UnInitialize(void)
{
	...
	if (vbo_Texture_Pyramid)
	{
		glDeleteTextures(1, &vbo_Texture_Pyramid);
		vbo_Texture_Pyramid = 0;
	}

	if (vbo_Texture_Cube)
	{
		glDeleteTextures(1, &vbo_Texture_Cube);
		vbo_Texture_Cube = 0;
	}
