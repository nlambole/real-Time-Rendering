...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindow(szClassName, TEXT("Two 2D Shapes : Nandlal Lambole"), WS_OVERLAPPEDWINDOW, Width, Height, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
void Initialize(void)
{
	...
	glBindBuffer(GL_ARRAY_BUFFER, 0);
	//new line
	glVertexAttrib3f(NRL_ATTRIBUTE_COLOR, 0.0f, 0.0f, 1.0f); // We used this when we give only one color to object
